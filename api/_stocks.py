"""Curated list of Indian stocks for autocomplete (NSE/BSE)."""
...
_INDEX = [(s["symbol"].lower(), s["name"].lower(), s) for s in STOCKS]
...
def search_stocks(query, limit=10):
    ...
    if not q:
        return []
    sp, np_, ct = [], [], []
    for sym_l, name_l, stock in _INDEX:
